...
import { SR6E } from "./helpers/config.mjs";
...
Hooks.once('init', async function() {
  ...
  Actors.registerSheet("sr6e", Shadowrun6ActorSheet, { makeDefault: true });
  Items.unregisterSheet("core", ItemSheet);
  Items.registerSheet("sr6e", Shadowrun6ItemSheet, { makeDefault: true });
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.sr6e.rollItemMacro("${data.uuid}");`;
